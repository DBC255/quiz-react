// useState é uma ferramenta que cria memoria quando o valor muda, a tela atualiza automaticamente
import React, {useState} from "react";

//View -> é como uma caixa que organiza os elementos
//text -> é o unico jeito de mostrar texto na tela
...
//Banco de perguntas
//uma lista de (Array) de objetos, cada objeto é uma pergunta com opções de respostas apenas uma
// resposta é a resposta correta
const PERGUNTAS = [
  {
